...
def upgrade() -> None:
    ...
    if "portfolio_usage_daily" not in tables:
        op.create_table(
...
def downgrade() -> None:
    ...
    _drop_index_if_exists(inspector=sa.inspect(bind), table_name="portfolio_usage_daily", index_name="ix_portfolio_usage_daily_org_usage_date")
    _drop_index_if_exists(inspector=sa.inspect(bind), table_name="portfolio_usage_daily", index_name="ix_portfolio_usage_daily_portfolio_date")
    _drop_index_if_exists(inspector=sa.inspect(bind), table_name="portfolio_usage_daily", index_name="ix_portfolio_usage_daily_usage_date")
    _drop_index_if_exists(inspector=sa.inspect(bind), table_name="portfolio_usage_daily", index_name="ix_portfolio_usage_daily_portfolio_id")
    _drop_index_if_exists(inspector=sa.inspect(bind), table_name="portfolio_usage_daily", index_name="ix_portfolio_usage_daily_organization_id")
