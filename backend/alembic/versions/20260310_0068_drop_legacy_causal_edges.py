"""drop legacy causal edges table

Revision ID: 20260310_0068
Revises: 20260310_0067
...
revision = '20260310_0068'
down_revision = '20260310_0067'
branch_labels = None
depends_on = None


def upgrade() -> None:
    op.drop_index(op.f('ix_causal_edges_industry_confidence'), table_name='causal_edges')
