"""add minimized saved review retrieval command

Revision ID: 20260819_0197
Revises: 20260819_0196
...
def downgrade() -> None:
    ...
    if receipt is not None or any(COMMAND in _commands(row[0]) for row in accounts):
        raise RuntimeError(
            "Cannot downgrade while saved-review command data exists. "
