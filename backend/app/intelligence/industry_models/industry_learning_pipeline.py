...
class IndustryLearningPipeline:
    ...
    def update_from_pattern(self, event: dict[str, Any]) -> None:
        ...
        model = self.registry.register_industry_model(industry)
        ...
        for item in patterns:
            ...
            if pattern_key:
                self.registry.increment_pattern(industry, pattern_key)
    ...
    def update_from_simulation(self, event: dict[str, Any]) -> None:
        ...
        if strategy:
            ...
            self.registry.record_strategy_outcome(industry, strategy, success_weight, simulation_weight)
    ...
    def update_from_outcome(self, event: dict[str, Any]) -> None:
        ...
        if strategy:
            ...
            self.registry.record_strategy_outcome(industry, strategy, success_weight, 1.0)
