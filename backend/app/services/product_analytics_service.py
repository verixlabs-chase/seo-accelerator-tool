    ...
    for spec in (
        ...
        ProductEventSpec(
            ...
            400,
            {
                ...
                "next_destination": _values("dashboard", "connections"),
            },
        ...
        ProductEventSpec(
            ...
            "activation",
            "customer-experience",
            "Measure whether customers begin the short role-aware product tour.",
            "1.0",
            180,
            {"persona": _values("solo", "multi", "team")},
            frozenset({"persona"}),
            "active",
            True,
        ),
        ProductEventSpec(
            ...
            "activation",
            "customer-experience",
            "Measure where customers continue or leave the short product tour.",
            "1.0",
            180,
            {
                "persona": _values("solo", "multi", "team"),
                "step_number": _values("1", "2", "3", "4"),
            },
            frozenset({"persona", "step_number"}),
            "active",
            True,
        ),
        ProductEventSpec(
            ...
            "activation",
            "customer-experience",
            "Measure completed role-aware product tours.",
            "1.0",
            400,
            {"persona": _values("solo", "multi", "team")},
            frozenset({"persona"}),
