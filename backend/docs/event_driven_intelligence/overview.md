...
## Purpose
This component exists to replace full batch recomputation with incremental, event triggered processing so the platform can scale to thousands of campaigns.
